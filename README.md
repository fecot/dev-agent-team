...
最初に [`workflows/feature-development.md`](workflows/feature-development.md) で 8 Phase の全体像を掴むのがおすすめです。実際の使い方は **A. オールインワン** と **B. 段階的** の 2 通りあります。
...
# 開発タスクごと
/run-feature-workflow <Issue URL or 依頼内容>
```
